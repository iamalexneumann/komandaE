...
foreach ($arResult as $arItem):
    ...
    <li class="footer-menu__col">
        <?php if ($arItem["PARAMS"]["NOT_LINK"] !== TRUE): ?>
        ...
        <?php else: ?>
        <span class="footer-menu__title"><?= $arItem['TEXT']; ?></span>
        <?php endif; ?>
        <ul class="footer-menu__submenu<?= ($arItem["PARAMS"]["TWO_COLUMNS"]) ? ' footer-menu__submenu_two-columns' : ''; ?>">
<?php
        else:
?>
